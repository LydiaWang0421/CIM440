var questions = ["Is Iceland always covered in ice?","What ocean lies east of the US?","What is Earth's largest continent?"];
var options = ["1) true 2) false","1) pacific 2) eastern 3) indian 4) atlantic","1) Europe 2) Antarctica 3) Asia 4) Africa"];
var answers = [1,3,2];
//each question counting by 0

var currentOption = -1;
//currentOption refers to what button the user has pressed
